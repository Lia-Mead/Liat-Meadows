var nl_lang = (window.nl_lang = 'en');
var nl_pos = (window.nl_pos = 'bl');
var nl_compact = (window.nl_compact = '1');
var nl_accordion = (window.nl_accordion = '1');
var nl_contact = (window.nl_contact =
  'n:Liat Meadows|u:meadowsliat+d:gmail.com');
var nl_color;
var nl_lic;
var nl_dir;
var phrases;
...
} else initNagishLi(nl_lang, nl_pos, nl_compact, nl_accordion, nl_contact);
function initNagishLi(lang, pos, compact, accordion, contact) {
  function ma(a, d) {
